  ...
  return (
    <header className="space-y-6 opacity-0 animate-[fadeIn_0.6s_ease-out_0.1s_forwards]">
      <div className="flex items-center gap-3">
        ...
        <span 
          onClick={onAssistantClick}
          className="text-[13px] font-medium tracking-tight cursor-pointer bg-gradient-to-r from-gray-900 via-orb-red/90 via-orb-red to-gray-900 bg-[length:200%_auto] animate-shimmer bg-clip-text text-transparent"
        >
          talk to my prans!
        </span>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-4 pt-6 tracking-tight text-sm">
            ...
            <ExternalLink href="mailto:ranjanvernekar69@gmail.com" text="Email" />
          </div>
        </div>
      </div>
    </header>
